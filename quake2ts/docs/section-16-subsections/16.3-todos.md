...
### 8. Remove `srcs` directory
- [x] Remove duplicate/stale `packages/game/srcs` directory

### 9. Address remaining functional TODOs
**File**: `packages/game/src/entities/funcs.ts`
- [x] Implement accel/decel for `angle_move_calc`
- [x] Verify `func_plat` accel/decel behavior matches `move_calc`

### 10. Camera System
**File**: `packages/game/src/entities/camera.ts`
- [x] Review and clean up HACK flags

### 11. Monster AI
**File**: `packages/game/src/entities/monsters/common.ts`
- [x] Implement `monster_done_dodge` logic and `AiFlags.Dodging`
...
- [x] Document/defer performance TODO (P2)
- [x] Defer polish TODOs to mission pack work (P3)
- [x] Clean up remaining code quality issues
