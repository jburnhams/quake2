...
damageAlpha: 0, // TODO
```
- [ ] Wire up actual player entity fields
- [ ] Get pmFlags from player.pmove
- [ ] Get viewangles from player.angles
- [ ] Get fov from player.fov or cvar
- [ ] Get ammo from current weapon
- [ ] Calculate damageAlpha from damage taken
- **Effort**: 1 day
...
```
- [ ] Parse worldspawn properties (sky, skyrotate, skyaxis, sounds)
- [ ] Call configstring API with parsed values
- [ ] Test: Map sky settings apply correctly
- **Effort**: 2 hours
...
```
- [ ] Add TE_BLOOD temp entity on gib spawn
- [ ] Spray particles
- **Effort**: 1 hour
...
```
- [ ] Add TE_MEDIC_CABLE_ATTACK temp entity
- [ ] Visual beam from medic to corpse
- **Effort**: 2 hours
...
```
- [ ] Implement after correctness verified
...
## Tasks
- [ ] Fix 4 critical TODOs (P1)
- [ ] Document/defer performance TODO (P2)
- [ ] Defer polish TODOs to mission pack work (P3)
- [ ] Verify no hidden TODOs remain

## Success Criteria
- [ ] All P1 TODOs completed or have tracking issues
- [ ] All TODOs have priority labels
