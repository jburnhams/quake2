...
- [x] Find all `: any` (Cleaned up `entity.ts`, `prox.ts`, `projectiles.ts`, `collision.ts`, `gibs.ts`, `misc.ts`)
...
- [x] Replace any types (Collision system surface passing, projectiles, prox mine, gibs, misc)
