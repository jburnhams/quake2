...
- [x] Implement flag physics
  ...
  - Drops on player death (Completed)
  - Returns to base after timeout (Completed)
...
- [x] Implement flag drop logic
  - Drop on death (Implemented)
  - Manual drop with command (Pending command registration system)
...
- [x] Implement capture scoring
  - Award team points (Pending scoreboard logic)
  - Award individual capture bonus (Implemented)
  - Reset flags to bases (Implemented)
  - Play capture sound/effect (Implemented)
