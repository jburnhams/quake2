...
- [ ] Add FRAME_attack42-51 animation sequence
- [ ] Add TE_MEDIC_CABLE_ATTACK visual effect
- [ ] Implement distance checking during resurrection (400 units max)
- [ ] Add multi-try logic with badMedic tracking
- [ ] Proper entity respawn via ED_CallSpawn equivalent
- [ ] Test: Medic resurrects corpse with cable visible

## 2. Medic Commander
- **Source**: `../rerelease/m_medic.cpp` (monster_medic_commander)
- **Missing entirely**
- [ ] Add medic_commander variant (600 HP vs 300)
- [ ] Implement reinforcement spawning system
- [ ] Add spawn animation (FRAME_attack33-55)
- [ ] Test: Commander spawns reinforcements

## 3. Berserk Jump Attack
- **File**: `packages/game/src/entities/monsters/berserk.ts`
- **Source**: `../rerelease/m_berserk.cpp:350-420`
- [ ] Add `berserk_high_gravity` variable gravity during jump
- [ ] Implement `T_SlamRadiusDamage` (300 kick, 165 radius)
- [ ] Add `berserk_jump_touch` collision handler
- [ ] Add SPAWNFLAG_BERSERK_NOJUMPING support
- [ ] Test: Jump creates shockwave, damages nearby

## 4. Soldier Variants
- **File**: `packages/game/src/entities/monsters/soldier.ts`
- **Source**: `../rerelease/m_soldier.cpp`
- **Current**: 3 variants | **Correct**: 6 variants
- [ ] Add soldier_ripper (50 HP, ripper weapon)
- [ ] Add soldier_hypergun (60 HP, hyperblaster)
- [ ] Add soldier_lasergun (70 HP, laser weapon)
- [ ] Implement missing weapon attacks
- [ ] Test: All 6 variants spawn and attack correctly
...
- [ ] Add blind_fire_target tracking
- [ ] Implement M_AdjustBlindfireTarget
- [ ] Enable shooting around corners
- [ ] Test: Tank shoots at player behind cover
