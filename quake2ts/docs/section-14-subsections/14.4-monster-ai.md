...
- [x] Add fidget animation (FRAME_stand31-70, 40 frames)
- [x] Add run-and-shoot (FRAME_runs01-06)
- [ ] Add jump sequences (gunner_move_jump, gunner_move_jump2) - **Skipped**: Standard Gunner model does not have jump frames (limit 208).
- [x] Add 3 pain sequences (currently only 1)
- [x] Implement duck behavior
- [x] Test: Gunner has full animation set
