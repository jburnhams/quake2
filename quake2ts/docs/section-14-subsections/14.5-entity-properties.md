...
- [ ] Add `lip` property (how much stays visible)
- [ ] Add `accel` / `decel` (movement curves)
- [ ] Add `dmg` (damage when blocking)
- [ ] Add `health` (shootable door)
- [ ] Add `sounds` (sound set 0-4)
- [ ] Add `wait` (auto-close delay)
- [ ] Parse spawnflags: TOGGLE, START_OPEN, CRUSHER, NOMONSTER, ANIMATED
- [ ] Test: All door types work correctly
