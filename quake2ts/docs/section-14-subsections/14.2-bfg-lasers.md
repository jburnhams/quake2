...
- The ammo consumption unit test and the integration test are currently failing. The core implementation is believed to be correct, but the tests are blocked.
