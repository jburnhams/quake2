...
- [x] All weapons have raise/lower/fire/idle animations (Infrastructure ready, Hand Grenade implemented, Shotgun implemented, Super Shotgun implemented, Machinegun implemented, Chaingun implemented, Rocket Launcher implemented, Blaster implemented, Grenade Launcher implemented, Hyperblaster implemented, Railgun implemented, BFG10K implemented)
...
- (Migrating other weapons to this system)

**Estimate**: Hand Grenade implementation is 100% complete. Weapon system infrastructure is in place.
