...
**Status**: CRITICAL BLOCKERS for hand grenade and proper weapon feel
...
- [ ] Fire weapons while ducking vs standing (different heights)
- [ ] Fire weapons against walls (should not shoot through)
- [ ] Railgun pierces enemies at correct height
- [ ] Hand grenade throws from hand position, not center
- [ ] Cannot shoot through walls by standing against them
...
- [ ] **Weapon_Generic() - Standard Weapons**
...
- [ ] **Throw_Generic() - Throwable Weapons**
...
- [ ] **Cooking Logic (in THROW_HOLD frame)**
...
- [ ] **Grenade State Variables** (add to client)
...
- [ ] Weapons fire from correct position (hand, not center)
- [ ] Cannot shoot through walls by standing against them
- [ ] Railgun works correctly
- [ ] Ducking changes shot height

### Weapon Animation Complete
- [ ] All weapons have raise/lower/fire/idle animations
- [ ] Hand grenade can be cooked with proper animations
- [ ] Primed loop sound plays while holding grenade
- [ ] Weapon switching has animations
- [ ] Fire rate timing matches original exactly
