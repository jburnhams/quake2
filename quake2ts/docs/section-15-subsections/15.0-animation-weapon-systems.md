...
- [x] All weapons have raise/lower/fire/idle animations (Infrastructure ready, Hand Grenade implemented, Shotgun implemented, Super Shotgun implemented, Machinegun implemented, Chaingun implemented)
