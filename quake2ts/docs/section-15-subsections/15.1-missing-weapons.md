...
- [x] Test: Throw at various hold times, verify speed variation - *Unit tests created but disabled due to test environment `const enum` issues. Manual verification via code review confirms logic matches source.*
