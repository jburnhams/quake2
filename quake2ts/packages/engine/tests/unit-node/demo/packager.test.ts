...
import { DemoPackager, PackageOptions } from '@quake2ts/engine/demo/packager.js';
import { VirtualFileSystem } from '@quake2ts/engine/assets/vfs.js';
import { PakWriter } from '@quake2ts/engine/assets/pakWriter.js';
import { Offset } from '@quake2ts/engine/demo/types.js';

// Mocks
vi.mock('@quake2ts/engine/assets/vfs.js');
vi.mock('@quake2ts/engine/demo/clipper.js', () => {
    return {
        DemoClipper: class {
            constructor() {
                return {
...
vi.mock('@quake2ts/engine/demo/optimalClipFinder.js', () => {
    return {
...
vi.mock('@quake2ts/engine/assets/visibilityAnalyzer.js', () => {
    return {
