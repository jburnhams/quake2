...
import { NetworkMessageParser, NetworkMessageHandler, ServerCommand, PROTOCOL_VERSION_RERELEASE } from '../../src/demo/parser.js';
...
describe('NetworkMessageParser', () => {
  it('should parse svc_configblast', () => {
    ...
    // Force protocol to Rerelease to avoid translation if needed
