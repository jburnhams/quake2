...
export const createRenderer = (
    ...
    const renderFrame = (options: FrameRenderOptions, entities: readonly RenderableEntity[]) => {
        ...
        const frustumPlanes = extractFrustumPlanes(viewProjection as unknown as number[]);
        ...
        for (const entity of entities) {
            ...
            if (entity.type === 'md2') {
                ...
                // Alternatively we could interpolate, but union is safer and cheaper than lerping all 6 values
                // Actually lerping bounds is fine too, but union covers the motion better.
                minBounds = {
