import { Vec3, PmoveTraceResult, CollisionModel, buildCollisionModel, CollisionLumpData } from '@quake2ts/shared';
...
export const trace = (start: Vec3, end: Vec3): PmoveTraceResult => {
...
export const pointContents = (point: Vec3): number => {
    // TODO: Implement the pointContents function
    return 0;
};
