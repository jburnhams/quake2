...
import { ProtocolPlayerState, createEmptyProtocolPlayerState, MutableVec3 } from '@quake2ts/shared';

// Re-export shared types for backward compatibility / downstream usage
export { ProtocolPlayerState, createEmptyProtocolPlayerState, MutableVec3 };
