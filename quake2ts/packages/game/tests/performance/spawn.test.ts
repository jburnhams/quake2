...
describe('Performance: Spawn Time', () => {
  it('should spawn 1000 entities in under 100ms', () => {
    ...
    const system = new EntitySystem({} as any, mockImports, undefined, 2048);
    ...
    for (let i = 0; i < ENTITY_COUNT; i++) {
      ...
      if (spawnFn1) spawnFn1(ent1, { keyValues: kv1, entities: system, imports: mockImports, warn: () => {}, free: () => system.free(ent1) } as any);
      ...
      if (spawnFn2) spawnFn2(ent2, { keyValues: kv2, entities: system, imports: mockImports, warn: () => {}, free: () => system.free(ent2) } as any);
