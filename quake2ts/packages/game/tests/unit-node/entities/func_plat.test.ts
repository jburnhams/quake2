...
import { createTestContext, createEntity, spawnEntity } from '@quake2ts/test-utils';
...
describe('func_plat', () => {
  ...
  it('should initialize func_plat', () => {
    ...
    const entity = spawnEntity(context.entities, createEntity({
      classname: 'func_plat',
      angles: { x: 0, y: 0, z: 0 },
    ...
    vi.spyOn(context.entities, 'spawn');
