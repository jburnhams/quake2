...
import { createTestContext, createEntityFactory, createTriggerEntityFactory, spawnEntity } from '@quake2ts/test-utils';
...
describe('func_train', () => {
  ...
  it('should initialize func_train', () => {
    ...
    const p1 = spawnEntity(context.entities, createTriggerEntityFactory('path_corner', {
      targetname: 'p1',
