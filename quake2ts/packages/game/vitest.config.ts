...
export default defineConfig({
  resolve: {
    alias: {
      ...
      '@quake2ts/test-utils/game/helpers': path.resolve(__dirname, '../test-utils/src/game/helpers.ts'),
      '@quake2ts/test-utils/game/factories': path.resolve(__dirname, '../test-utils/src/game/factories.ts'),
      '@quake2ts/test-utils/game/mocks/ai': path.resolve(__dirname, '../test-utils/src/game/mocks/ai.ts'),
      '@quake2ts/test-utils/game/mocks/combat': path.resolve(__dirname, '../test-utils/src/game/mocks/combat.ts'),
      '@quake2ts/test-utils/game/mocks/items': path.resolve(__dirname, '../test-utils/src/game/mocks/items.ts'),
      '@quake2ts/test-utils/engine/mocks/assets': path.resolve(__dirname, '../test-utils/src/engine/mocks/assets.ts'),
      '@quake2ts/test-utils/shared/bsp': path.resolve(__dirname, '../test-utils/src/shared/bsp.ts'),
      '@quake2ts/test-utils/shared/collision': path.resolve(__dirname, '../test-utils/src/shared/collision.ts'),
