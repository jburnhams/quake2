...
- [ ] Output matches WASM reference within floating-point tolerance *(Deferred, see Section 25-9)*
- [x] Generated BSPs load in quake2ts engine
- [ ] Performance acceptable for real-time procedural generation of simple maps *(Deferred, see Section 25-9)*
